package com.thezayin.dadjokes.core.framework.utils

object Constants {
    const val JOKES_TABLE = "jokes_table"
    const val BASE_URL = "https://icanhazdadjoke.com/"
    const val PRIVATE_POLICY_URL =
        "https://dadjokesprivacypolicy.blogspot.com/2024/03/privacy-policy-effective-date-29-march.html"
